...
const BusinessClubPage: React.FC = () => {
	...
	return (
		<>
			<Head>
				<title>
					Сектор C123-C119 | ФК Акрон - Динамичные места для активных
					болельщиков
				</title>
				<meta
					name='description'
					content='Секторы C123 и C119 — места для активных болельщиков. Динамичный обзор игры, близость к действию, возможность поддержать команду на всех участках поля.'
				/>
				<meta
					name='keywords'
					content='сектор C123, сектор C119, активные болельщики, ФК Акрон, футбол, динамичные места, стадион, поддержка команды'
				/>
			</Head>
