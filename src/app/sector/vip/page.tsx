...
const BusinessClubPage: React.FC = () => {
	...
	return (
		<>
			<Head>
				<title>VIP-ложи и Skybox | ФК Акрон - Премиум места на стадионе</title>
				<meta
					name='description'
					content='VIP-ложи и Skybox на стадионе Акрон — премиум места с лучшим обзором поля. Приватность, комфорт, гастрономия. Забронируйте эксклюзивные места для просмотра футбола.'
				/>
				<meta
					name='keywords'
					content='VIP-ложи, Skybox, премиум места, ФК Акрон, стадион, футбол, приватность, комфорт, гастрономия, бронирование'
				/>
			</Head>
