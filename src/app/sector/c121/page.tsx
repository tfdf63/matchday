...
const BusinessClubPage: React.FC = () => {
	...
	return (
		<>
			<Head>
				<title>
					Сектор C121 | ФК Акрон - Центральные места с отличным обзором атак
				</title>
				<meta
					name='description'
					content='Сектор C121 — идеальные места для наблюдения за атакующими действиями команды. Центральная трибуна, отличный обзор ворот соперника, аутентичная атмосфера футбола.'
				/>
				<meta
					name='keywords'
					content='сектор C121, центральная трибуна, атаки, ФК Акрон, футбол, классические места, стадион, ворота'
				/>
			</Head>
