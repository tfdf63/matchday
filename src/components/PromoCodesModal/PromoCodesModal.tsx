						...
						<>
							<span>
								...
								<span
									...
									onTouchEnd={() => handleCopy('AKRRPL10')}
									tabIndex={0}
									role='button'
									aria-label='Скопировать промокод AKRRPL10'
								>
									AKRRPL10
									{copied === 'AKRRPL10' && (
							...
							<span>
								...
								<span
									...
									onTouchEnd={() => handleCopy('AKRRPL15')}
									tabIndex={0}
									role='button'
									aria-label='Скопировать промокод AKRRPL15'
								>
									AKRRPL15
									{copied === 'AKRRPL15' && (
										<span className={styles.copied}>✓</span>
							...
							<span>
								...
								<span
									...
									onTouchEnd={() => handleCopy('AKRRPL20')}
									tabIndex={0}
									role='button'
									aria-label='Скопировать промокод AKRRPL20'
								>
									AKRRPL20
									{copied === 'AKRRPL20' && (
										<span className={styles.copied}>✓</span>
