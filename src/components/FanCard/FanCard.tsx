	...
	const steps = [
		{
			...
			details: [
				'Если хотите посетить матч вместе с ребенком до 14 лет, то вам необходимо оформить её в своём личном. Для этого при заполнении заявления нужно указать данные и загрузить фото ребенка.',
