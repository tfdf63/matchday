...
export function contentMatchToGame(row: ContentMatch): Game {
	return {
		...
		ticketLinkLabel: row.ticketLinkLabel,
		ticketLinkVip: row.ticketLinkVip,
		ticketLinkVipLabel: row.ticketLinkVipLabel,
		ticketLinkSkybox: row.ticketLinkSkybox,
		ticketLinkSkyboxLabel: row.ticketLinkSkyboxLabel,
		...
		ticketLinkC4PriceFrom: row.ticketLinkC4PriceFrom,
		ticketLinkBusinessClub: row.ticketLinkBusinessClub,
		ticketLinkFanNew: row.ticketLinkFanNew,
		ticketLinkFanNewPriceFrom: row.ticketLinkFanNewPriceFrom,
